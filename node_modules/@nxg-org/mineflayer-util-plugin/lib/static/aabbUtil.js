...
const node_aabb_1 = require("node-aabb");
var AABBUtils;
(function (AABBUtils) {
    function getBlockAABB(block, height = 1) {
        const { x, y, z } = block.position;
        return new node_aabb_1.AABB(x, y, z, x + 1, y + height, z + 1);
    }
    ...
    function getPlayerAABB(entity) {
        ...
        return new node_aabb_1.AABB(-hw, 0, -hw, hw, entity.height ? entity.height + 0.18 : 1.8, hw).translateVec(entity.position);
    }
    AABBUtils.getPlayerAABB = getPlayerAABB;
    function getPlayerAABBRaw(position, height = 1.8) {
        return new node_aabb_1.AABB(-0.3, 0, -0.3, 0.3, height, 0.3).translateVec(position);
    }
    ...
    function getEntityAABBRaw(entity) {
        ...
        return new node_aabb_1.AABB(-hw, 0, -hw, hw, entity.height, hw).translateVec(entity.position);
    }
